...
def build_gmsh() -> None:
    ...
    # Move files into common directory
    shutil.copytree(os.path.join(BUILD_DIR, lib, 'usr', 'lib64/')  , '/io/build/lib64'  , dirs_exist_ok=True)
    try:
    ...
    shutil.copytree(os.path.join(BUILD_DIR, lib, 'usr', 'lib64/')  , '/io/build/lib64'  , dirs_exist_ok=True)
    shutil.copytree(os.path.join(BUILD_DIR, lib, 'usr', 'include/'), '/io/build/include', dirs_exist_ok=True)
    shutil.copytree(os.path.join(BUILD_DIR, lib, 'usr', 'share/')  , '/io/build/share'  , dirs_exist_ok=True)
    ...
    filedata = filedata.replace('/usr', '/io/build')
