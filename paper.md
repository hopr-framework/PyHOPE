...
For this example, the CAD file is initially meshed using second-order simplex elements in the external generator ANSA v24 [@ansa2024] and the three-dimensional grid is exported in high-order curved CGNS 4.2.0 format based on HDF5.
...
Notably, this workflow enables full utilization of CFD meshes generated by commercial tools such as ANSA and Pointwise [@pointwise2025], which are widely used in industry.
